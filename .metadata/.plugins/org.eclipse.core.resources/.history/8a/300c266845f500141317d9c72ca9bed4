...
public class FileShowActivity extends BaseActivity {
	...
	public void onDestroy() {
		com.test.ftpclient.utils.FileUtils.deleteAll(getCacheDir());
		super.onDestroy();
	}
