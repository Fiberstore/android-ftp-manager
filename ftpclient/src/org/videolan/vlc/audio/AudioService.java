...
import com.test.ftpclient.BuildConfig;
    ...
    private void showNotification() {
        try {
            ...
            if (LibVlcUtil.isJellyBeanOrLater()) {
                ...
                RemoteViews view = new RemoteViews(Utils.getPackName(this), R.layout.notification);
                ...
                RemoteViews view_expanded = new RemoteViews(Utils.getPackName(this), R.layout.notification_expanded);
                ...
                if (LibVlcUtil.isLolliPopOrLater()){
                    ...
                    builder.setVisibility(Notification.DEFAULT_ALL);
                }
